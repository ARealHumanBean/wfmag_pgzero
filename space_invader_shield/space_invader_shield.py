import pgzrun
from pgzero.builtins import Actor, animate, keyboard, Rect, images, clock # make linter stop complaining
...
def create_random_shot():
  shots.append({
    'pos': [randint(0, (WIDTH-images.shot.get_width())/10)*10, 0],
    'sprite': images.shot,
    'exploding': False})

clock.schedule_interval(create_random_shot, 0.5)
